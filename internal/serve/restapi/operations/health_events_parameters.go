...
func NewHealthEventsParams() HealthEventsParams {
	...
	return HealthEventsParams{}
}

// HealthEventsParams contains all the bound params for the health events operation
// typically these are obtained from a http.Request
//
// swagger:parameters healthEvents
type HealthEventsParams struct {

	// HTTP Request Object
	HTTPRequest *http.Request `json:"-"`

	/*topic_stub of the experiment e.g pend00 (not r-pend00)
	  Required: true
	  In: path
	*/
	Name string
...
func (o *HealthEventsParams) bindName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
